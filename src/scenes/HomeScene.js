...
const NOTICES = {
  ...
  story: [
    ...
    { id: "st2", title: "わすれの国と わすれもの", body: "捨てられた気持ちは 消えず、世界の裏側「わすれの国」に沈む。行き場をなくした気持ちは、やがて「わすれもの」という魔物になる。旅で出会う魔物は、みんな だれかの わすれものだ。" },
    { id: "st3", title: "君の役目", body: "君は、わすれものの声が 聞こえる 珍しい子。魔物になった気持ちを 拾い集めて、元のやさしい姿に もどす旅人だ。相棒の子も、君が最初に拾った気持ちだよ。" },
  ],
};
