...
const NOTICES = {
  ...
  story: [
    { id: "st1", title: "はじまり", body: "昔、この世界の人たちは 気づいた。「つらい気持ちなんて、なければ楽なのに」と。そうして みんな、悲しみや怒りを 少しずつ 捨てはじめた。" },
    { id: "st2", title: "魔物のしょうたい", body: "捨てられた気持ちは、消えたわけじゃなかった。行き場をなくして さまよい、やがて 魔物になる。旅で出会う魔物は、みんな だれかが捨てた気持ちなんだ。" },
    { id: "st3", title: "君の役目", body: "君は、その魔物になった気持ちを 拾い集めて、元のやさしい姿に もどしてあげる旅人。相棒の子も、君が最初に拾った気持ちだ。" },
  ],
};
...
export default class HomeScene extends Phaser.Scene {
  ...
  // 金の彫刻フレーム（ui/ornate.js の共用ヘルパーへ委譲。Game/Home で同じ額縁）
  drawOrnateFrame(gfx, x, y, w, h, r = 10, opts = {}) {
    ornateFrame(gfx, x, y, w, h, r, opts);
  }
