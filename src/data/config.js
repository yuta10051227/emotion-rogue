...
export const BOSS = {
  ...
  //  lore＝ボス登場時に流れる一行（芥見流：敵＝誰かが捨てた巨大な感情。倒す＝浄化）。
  types: {
    anger: { name: "業火の主", icon: "👹", lore: "守れなかった者が捨てた《怒り》。\n守るものを失った炎は、ただ焼くことしか知らない。" },
    sadness: { name: "慟哭の淵", icon: "🌧️", lore: "見送ることしか できなかった者の《悲しみ》。\n涙は淵となり、近づく者を沈める。" },
    courage: { name: "雷鳴の王", icon: "⚔️", lore: "踏み出せなかった夜に捨てられた《勇気》。\n行き場を失い、空へ吼えつづける。" },
    hope: { name: "黄昏の使者", icon: "🌟", lore: "幾度も裏切られ、手放された《希望》。\nそれでも、拾われるのを待っている。" },
  },
  // 空白の王の伏線（生涯ボス撃破数がこの数に達した時、一度だけ流れる。脅威が旅の間に育つ）。
  foreshadow: [
    { atKills: 1, id: "vk1", text: "── どこかで、声がした。\n「……また、拾うのか。無駄なことを」" },
    { atKills: 3, id: "vk2", text: "声は、少し近づいた。\n「拾っても、また捨てる。お前も いずれ そうなる」" },
    { atKills: 6, id: "vk3", text: "声は、もう君の内側にいた。\n「感情など、捨ててしまえば楽になれる」──それが、空白の王。" },
  ],
};
